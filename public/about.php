...
<ul class="features">
    <li><span class="fa fa-feather"></span>Lightweight</li>
    <li><span class="fa fa-puzzle-piece"></span>Easy to Use</li>
    <li><span class="fa fa-pencil-alt"></span>Customizable</li>
    <li><span class="fa fa-handshake"></span>Collaborative</li>
</ul>
